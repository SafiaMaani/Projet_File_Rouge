...
<div class="d-flex bg-light">
    ...
    <form method="post" onsubmit="return(validationProduit())" class="d-flex flex-column justify-content-center w-75">
        <label class="mb-1">Nom : </label>
        <input class="mb-1 form-control" type="text" name="name" id="full_name" value="<?= $produitData['name'] ?>">
